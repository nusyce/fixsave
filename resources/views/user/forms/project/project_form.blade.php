<div class="modal-body">
    <div class="form-body">
        <div class="formrow" id="div_name">
            <input style="margin-bottom: 14px;" class="form-control" id="name" placeholder="{{__('Projektname')}}" name="name" type="text" value="{{(isset($profileProject)? $profileProject->name:'')}}" required ="">
            <span class="help-block name-error" style="color: #ea5c90;"></span> </div>
        ...
        <div class="formrow" id="div_image">
            ...
            <span  style="color: #ea5c90;" class="help-block image-error"></span> </div>
        <div class="formrow" id="div_url">
            <input style="margin-bottom: 14px;" class="form-control" id="url" placeholder="{{__('Projekt-URL')}}" name="url" type="text" value="{{(isset($profileProject)? $profileProject->url:'')}}">
            <span  style="color: #ea5c90;" class="help-block url-error"></span> </div>
        <div class="formrow" id="div_date_start">
            <input  style="margin-bottom: 14px;" class="form-control datepicker" id="date_start" placeholder="{{__('Startdatum des Projekts')}}" name="date_start" type="text" autocomplete="off" value="{{(isset($profileProject)? $profileProject->date_start:'')}}">
            <span  style="color: #ea5c90;" class="help-block date_start-error"></span> </div>
        <div class="formrow" id="div_date_end">
            <input  style="margin-bottom: 14px;" class="form-control datepicker" autocomplete="off" id="date_end" placeholder="{{__('Enddatum des Projekts')}}" name="date_end" type="text" value="{{(isset($profileProject)? $profileProject->date_end:'')}}">
        ...
        <div class="formrow" id="div_is_on_going">
            ...
            <span  style="color: #ea5c90;" class="help-block is_on_going-error"></span>
        </div>

        <div class="formrow" id="div_description">
            <textarea  style="margin-bottom: 14px;" name="description" class="form-control" id="description" placeholder="{{__('Beschreibung des Projekts')}}">{{(isset($profileProject)? $profileProject->description:'')}}</textarea>
