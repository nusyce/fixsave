...
--}}
            ...
            <div class="row" style="margin-left: 30px;">
                ...
                <div class="col-lg-4" class="checkbox_container">
    ...
    <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <textarea name="kommentar" id="ctrl_27" class="form-control form-control-sm" rows="4" cols="25" maxlength="2000"></textarea>
           ...
           <div class="row" style="margin-left: 16px;">
            <div>
                <p style="color: #C60C30;"><span class="warning"><span style="text-decoration: underline;">Pro Auswahlfeld</span> kann <span style="text-decoration: underline;">nur eine Datei</span> (max. 8 MB) ausgewählt werden.</span><span style="color: #003f72;">
                    <br>Ein Anschreiben ist <span style="text-decoration: underline;">nicht</span> erforderlich, außer es wird in der Anzeige ausdrücklich darauf hingewiesen. 
                    <p>Haben Sie mehrere Zeugnisse, fassen Sie diese bitte in einer Datei zusammen.</p></span></p>
                <p>Folgende Dateiendungen sind erlaubt: <br>pdf,doc,docx,odt,rtf,jpg,jpeg,gif,png,tiff,bmp</p>
            </div>
           </div> <br>
    <div class="row">

            <div class="col-lg-3 offset-lg-1 colordiv" style="border:1px solid #003A65;padding:10px;margin-bottom: 20px;color:#003A65;">
