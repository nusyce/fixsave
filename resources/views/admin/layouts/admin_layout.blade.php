        ...
        <div class="page-header navbar navbar-fixed-top"> 
            ...
            <div class="page-header-inner "> 
                ...
                <div class="page-logo">{{-- <a href="{{ route('admin.home') }}"> <img src="{{ asset('/') }}sitesetting_images/thumb/{{ $siteSetting->site_logo }}" alt="logo" style="max-width:170px; max-height:40px;" /> <!-- class="logo-default" --></a>--}}
                    ...
                    <a href="{{ route('admin.home') }}" style="max-width:170px; max-height:40px;position:relative;bottom: 10px;" ><!--<img src="{{ asset('/') }}sitesetting_images/thumb/{{ $siteSetting->site_logo }}" alt="{{ $siteSetting->site_name }}"/>--><h2>FlixSave24</h2></a>
