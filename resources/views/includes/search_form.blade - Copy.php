    ...
    <div class="searchbar">
		...
		<div class="input-group">
		  ...
		  <span class="input-group-btn">
			<input type="submit" class="btn" value="{{__('Stelle suchen Seeker')}}">
		  </span>
		</div>
		</div>
...
<form action="{{route('job.list')}}" method="get">
    <div class="searchbar">
		...
		<div class="input-group">
		  <input type="text"  name="search" id="jbsearch" value="{{Request::get('search', '')}}" class="form-control" placeholder="{{__('Stellenbezeichnung oder Fähigkeiten')}}" autocomplete="off" />
		  <span class="input-group-btn">
