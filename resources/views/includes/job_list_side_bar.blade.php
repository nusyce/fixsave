<div class="col-md-3 col-sm-6"> 
	...
	<a class="btn btn-job-alert" href="javascript:;">
		<i class="fa fa-bell" style="font-size:1.125rem;"></i> {{__('Job-alarm speichern')}} </a>
	@else
	...
	@else
	<a href="{{url('my-profile#cvs')}}" class="btn"><i class="fa fa-file-text" aria-hidden="true"></i> {{__('Lebenslauf hochladen')}}</a>
	@endif
	</div>
    <!-- Side Bar start -->
    <div class="sidebar">
        ...
        <!-- Jobs By Title -->
        <div class="widget">
            <h4 class="widget-title">{{__('Titel')}}</h4>
