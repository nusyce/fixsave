<div class="col-md-3 col-sm-4">
    ...
    <ul class="usernavdash">
        ...
        <li <?=Request::path()=='company-detail'?'class="active"':''?>><a href="{{ route('company.detail', Auth::guard('company')->user()->slug) }}"><i class="fa fa-user" aria-hidden="true"></i> {{__('Profil')}}</a></li>
        ...
        <li <?=Request::path()=='my-favourite-jobsb'?'class="active"':''?>><a href="{{ route('my.favourite2.jobs') }}"><i class="fa fa-heart" aria-hidden="true"></i> {{__('Favoriten')}}</a>
        </li>
