                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-sm-8">
                        ...
                        <div class="candidateinfo">
                          ...
                          {{--  @if(!empty($company->plz))

                                <div class="loctext"><span>Plz :</span> </div>

                            @endif
--}}
                           {{-- @if(!empty($company->stadt))

                                <div class="loctext"><span>Plz :</span>{{$company->stadt}} </div>

                            @endif
--}}
                           {{-- @if(!empty($company->strabe))

                                <div class="loctext"><span>straße :</span>{{$company->strabe}} </div>
...
{{--
                            ...
                            @if(!empty($company->land))
                                ...
                                <div class="loctext"><span style="font-weight: bold">Land </span>{{$company->land}} </div>

                            @endif


                            @if(!empty($company->bundesland))

                                <div class="loctext"><span style="font-weight: bold">Bundesland </span>{{$company->bundesland}} </div>

                            @endif
                            @if(!empty($company->hausnummer))

                                <div class="loctext"><span style="font-weight: bold">Hausnummer </span>{{$company->hausnummer}} </div>
