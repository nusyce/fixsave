...
class Job extends Model
{
    ...
    protected $fillable = [
        ...
        'title', 'geschlecht', 'vertragsart','branche','beruf','bereich','zeit','options','wochenstunden','start','verdienstpro','verdienstim','land','bundesland','plz','stadt','arbeitsort','deutschlevel','englischlevel','sonstige','fuhrerschein','unterkunft','ausstattung','wanie','description','expiry_date'
